...
## 🟢 Пример из финального отчёта:

|Техника|Действие|Временная метка|Пользователь|
|---|---|---|---|
|T1059.001|PowerShell Execution|2019-03-10 12:30:35 UTC|Wilfred|
|T1053.005|Scheduled Task|2019-03-10T05:56:46|Support|
|T1547.001|Updater.bat в AppData|2019-03-09 18:27:01|Wilfred|

---

✅ Все ключевые места содержат:

- Дату и время действий;
    
- Учётную запись пользователя, от имени которого выполнялись действия.
